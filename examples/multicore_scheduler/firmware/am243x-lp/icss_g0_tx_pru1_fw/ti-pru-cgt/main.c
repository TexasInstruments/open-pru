 ...
 *  \file   main.c
 *
 *  \brief  Multi-core scheduling configuration and code for TXPRU1
 */
/* ========================================================================== */
/*                             Include Files                                  */
/* ========================================================================== */
...
/* ========================================================================== */
void FN_PWM_INIT_TOGGLE_TXPRU1_TASK();
/* ========================================================================== */
/*                          Macros                                            */
/* ========================================================================== */
#define TM_REG_BASE_TXPRU1 CSL_ICSS_G_PR1_TASKS_MGR_PRU_TX1_PR1_TASKS_MGR_PRU_TX1_MMR_REGS_BASE
...
/* ---------- task manager configuration ------------------- */
    ...
    HW_WR_REG32((TM_REG_BASE_TXPRU1+TASKS_MGR_GLOBAL_CFG), 0x0fff);
    asm("   xin     252, &r0.b3,1");
    asm("   nop ");
    asm("   nop ");
    HW_WR_REG32((TM_REG_BASE_TXPRU1+TASKS_MGR_GLOBAL_CFG), 0x0000);
    /* configure task manager, TS2 is highest priority and can pre-empt TS1
    *  general purpose mode = 2 ,
    *  TS2_S0 task enable  (bit 7)
    */
    HW_WR_REG32((TM_REG_BASE_TXPRU1+TASKS_MGR_GLOBAL_CFG), 0x0082);
    /* set address of tasks in TS2_0*/
    HW_WR_REG32((TM_REG_BASE_TXPRU1+TASKS_MGR_TS2_PC_S0), (unsigned int)FN_PWM_INIT_TOGGLE_TXPRU1_TASK);
