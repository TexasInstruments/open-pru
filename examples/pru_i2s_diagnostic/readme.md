...
##### Block Diagram
![Block_Diagram](images/block_diagram_am263x.png)
...
- Another way to verify is to connect external TDM/I2S signal generator and connect to Rx pin of PRU1 and see the data in "gPPruI2s1RxBuf"
