...
OPEN PRU is designed with user experience and simplicity in mind. The repository includes out-of-box Getting started PRU labs, Macro definations and application examples.

## Features

- Out of Box Getting started labs, Macro definations and application Examples
  - Getting started labs: Task mangager, Interrupt controller, Broadside accelerator etc.,
  - Application examples: ADC, SENT, I2C, I2S etc.,
  - Macro definations of PRUSS, PRUICSSM, PRUICSSG components

## Overview

---

![Software Block Diagram](docs/open_pru_block.png)

--- MCU+ SDK is dependency for OPEN PRU repo while working with Sitara MCU and MPU class of devices, Users can use Prebuilt SDK installers for specific devices or clone MCU+ SDK repository
...
TI has an amazing collection of tutorials as PRU Labs to help you get started.
...
### More information on OPEN PRU Repository usage

For more details on Repository usage, please refer to the Getting started section of MCU+ SDK README_FIRST_*.html page. User guides contain information on
