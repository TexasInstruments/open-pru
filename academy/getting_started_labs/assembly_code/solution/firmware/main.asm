...
; FEEDBACK: are these comments correct?
    ; .retain & .retainrefs before any .sect directive mean that section .text
    ; cannot be optimized out during the build process via conditional linking.
...
; FEEDBACK: is this comment correct?
; .sect ".text:main" places all code below the .sect directive into the .text
; section, grouped into an object named "main"
    .sect       ".text:main"
; FEEDBACK: should clink be removed? What does this do?
    .clink
    .global     main
