...
This example implements Multiply and Accumulate functionality in C. It does NOT
currently use the PRU MAC (Multiply and Accumulate) hardware accelerator.

## Overview

This example allocates 256 pairs of 32-bit operands
...
|-----------|-----------|-----------------------------------------------------------------------------|
| AM62x     | SK-AM62B  | TI PRU CGT v2.3.3, CCS 12.7, OpenPRU v2026.01.00          |
| AM64x     | TMDS64EVM | TI PRU CGT v2.3.3, CCS 12.7, OpenPRU v2026.01.00          |
